...
const ApplicationList: React.FC = () => {
  const { applications, jobs, resumes } = useAppStore();
        ...
        <div className="flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              placeholder="Search applications by job title, company, or resume"
              value={searchTerm}
                    ...
                    <div className="px-4 py-4 sm:px-6">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <p className="text-sm font-medium text-indigo-600 truncate">{job?.title || 'Unknown Position'}</p>
                      ...
                      <div className="mt-2 sm:flex sm:justify-between">
                        ...
                        <div className="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
                          ...
                          <p>
                            Applied on <time dateTime={application.appliedDate}>{format(new Date(application.appliedDate), 'MMM d, yyyy')}</time>
                          </p>
                        </div>
                      </div>
                    </div>
